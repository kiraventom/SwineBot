...
public class InvalidChecker(ILogger<InvalidChecker> logger, UserContext context, IDateTimeNowProvider dtnProvider) : AchievementChecker(logger, dtnProvider, context)
{
